...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`GoudenWask`}</title>

        <meta
          name="description"
          content="Experience the pinnacle of cleanliness with GoudenWask, your ultimate car wash application designed to make vehicle maintenance effortless and efficient."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1565689876697-e467b6c54da2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMjB3YXNofGVufDB8fHx8MTcwMDAwNDMwOXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@dascal?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Adrian Dascal`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the pinnacle of cleanliness with GoudenWask, your ultimate car wash application designed to make vehicle maintenance effortless and efficient.`}
            </Text>
            <Box
