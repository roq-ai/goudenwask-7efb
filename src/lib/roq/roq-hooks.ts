...
export function useCarWashFindMany<
...
>(
  ...
  const key = JSON.stringify(['useCarWashFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.car_wash_.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCarWashCount<T extends Prisma.car_wash_CountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.car_wash_CountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useCarWashCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.car_wash_.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCarWashFindManyWithCount<
  T extends Prisma.car_wash_FindManyArgs,
  R extends { data: GetFindResult<Prisma.$car_wash_Payload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.car_wash_FindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCarWashFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.car_wash_.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCarWashFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCarWashFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.car_wash_.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
